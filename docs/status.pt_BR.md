...
## Testes (2211 = 1904 kof-compiler + 38 kof-script + 7 kof-c-compiler + 262 kof-cli — suíte completa verde, 0 regressões (1 falha = o flake intermitente conhecido do §252 nativo) / 0 erros, 190 skip; medição 16/09 ~05:34 num clone limpo de `574c9419`. Host sem qemu: cross → skip honesto)
