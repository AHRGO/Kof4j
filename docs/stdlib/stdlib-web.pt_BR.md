...
**Versão:** 0.5.0-beta (`kof.http` JVM+JS + retry/circuit; WebSocket/SSE JVM + hardening)
...
## 5. Limitações atuais (Fase 1, 0.5.0-beta)
...
- Plano: `docs/development/DECISIONS.md` §D-SPRING (Fase 1)
