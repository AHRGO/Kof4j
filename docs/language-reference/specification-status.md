...
| C FFI (`extern "<lib>"`) | **Partial** — JVM any scalar signature, free arity, `void`/`String` returns (18/09, `.18`); non-scalar = `FFI001`; JS = `FFI002` (host bridge `KofJsFfiBridge`, queue 3.6.F2/F3); Native = `FFI001` §61 (R6, never silent) | measured 18/09 (`modules.md` §6; fmod/ldexp/strncmp/puts/getenv verbatims in `syntax.md`) (`IMPLEMENTATION-UNIVERSAL-PLATFORM.md`, #431) |
