...
## Tests (2211 = 1904 kof-compiler + 38 kof-script + 7 kof-c-compiler + 262 kof-cli — full suite green, 0 regressions (1 failure = the known intermittent §252 native flake) / 0 errors, 190 skip; measured 16/09 ~05:34 on a clean clone of `574c9419`. Host without qemu: cross → honest skip)
