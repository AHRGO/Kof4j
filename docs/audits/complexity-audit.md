...
> 12/09 e daí p/ `docs/audits/` no refactor de clareza de 13/09**: a foto é de 02/09 (0.2.6-beta, 810 testes) e os números de linhas já
...
> `scripts/check_500.sh` + `docs/architecture/PLAN-SOLID-500.md` (FECHADO 13/09).
