...
| 13 | faces de arquivo do `kof.io` no cross | ✅ | ✅ x86 | 🟡 parcial — estat (`exists`/`isFile`/`isDirectory`) ✅ (`NativeRiscvAsmIoStat`); read/write/dir ❌ `NAT006` | ✅ | `NAT006`/`NAT007` | lane native cross |
