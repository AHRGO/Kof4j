...
| 8 | `PLAN-UNIVERSAL-PLATFORM.md` | `IN PROGRESS` — **promoted from `future/` 17/09** (`DECISIONS.md` §D-UNIVERSAL, R12 overridden); architecture active | maintainer directive 17/09: promote and implement | **Stage 1 (SYSTEMS consolidation) + R1–R12** — pick the first unowned executable slice (1.1 MEDIA / 1.5 OTel export appear unowned; 1.2 GC x86 = nat lane; 1.4 registry = maintainer decision); claim in `DOING.md` before code |
