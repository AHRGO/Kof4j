...
- **Pending (the release gate's condition 3):** `ffi-abi-structs.md`
  ...
  `makealive-plan.md` (residual 3.2/3.7 — **3.2 DECIDED 21/09 `D-MAKEALIVE-SYNTAX`** (pure sugar over `design()`, IN IMPLEMENTATION owner `.18`/9093) **unblocks 3.7**; 3.8 shipped 20/09 `D-MAKEALIVE-CLI`).
