...
| ~~`known-bugs.md`~~ → `docs/bugs-and-gaps/` | **18 live** (resynced 21/09 by `scripts/check_known_bugs_status.sh`; was 20 — §380 `9f383bcf`, §381 `576a1dcb`, §394 `d0464385` and §353 21/09 closed; the §2 live set is the authority; the historical 14/09 count was 32; §81/§163/§127-JVM, §155, §94, §157-160 and §65 closed/DOES-NOT-REPRODUCE 13/09) | live queue |
