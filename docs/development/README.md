...
|---|---|---|
| `PLAN-TREE-SHAKING.md` | S-1..S-5(cross) ✅ (poda + gc-sections riscv/aarch; riscv 258→103→18 syms medido; x86=32.520B/37) | restam S-5-x86 (fila bugfix, root_end), S-6 (Vini), S-7 |
