...
| 7 | Nothing pending in bugs-and-gaps | `check_known_bugs_status.sh` live set empty + `specification-gaps.md` 0 open | RED (16 live at the tip; an unreadable ledger is `UNKNOWN`, never GREEN) |
