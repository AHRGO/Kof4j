...
**20 itens na fila aberta** (ressincronizado 21/09 — 23→22 quando **§429** (request desconhecida no LSP agora responde `-32601`, lane docs/plataforma) foi CORRIGIDO ✅ 21/09, 22→21 quando **§431** (tooling drift da CLI, lane `.18`) foi CORRIGIDO ✅ 21/09; 20→19
