...
| — | `makealive-plan.md` (+PT) — D-MAKEALIVE (DECIDIDO 19/09, `DECISIONS.md`): makealive como superficie de primeira classe da plataforma; fatia 3.0.1 recon FECHADA, 3.1 [core] EM CURSO (lane `.18`) | `DECIDIDO → EM DESENVOLVIMENTO` | 20/09 |
