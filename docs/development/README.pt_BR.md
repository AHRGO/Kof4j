...
- **Pendentes (condição 3 do gate de release):** `ffi-abi-structs.md`
  ...
  plataforma) · `makealive-plan.md` (resíduos 3.2/3.7 — **3.2 DECIDIDA 21/09 `D-MAKEALIVE-SYNTAX`** (açúcar puro sobre `design()`, EM IMPLEMENTAÇÃO dono `.18`/9093) **destrava a 3.7**; 3.8 pousado 20/09 `D-MAKEALIVE-CLI`).
