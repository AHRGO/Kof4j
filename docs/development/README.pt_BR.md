...
13/09, ressincronizada 14/09 ~22:15, **contagem viva ressincronizada 20/09**
...
**20 itens na fila aberta** (medido 20/09 por
...
| ~~`known-bugs.md`~~ → `docs/bugs-and-gaps/` | **20 vivos** (medido 20/09 por `scripts/check_known_bugs_status.sh` — a fila viva do §2 é a autoridade; a contagem histórica de 14/09 era 32; §81/§163/§127-JVM, §155, §94, §157-160 e §65 fechados/NÃO-REPRODUZ 13/09) | fila viva |
