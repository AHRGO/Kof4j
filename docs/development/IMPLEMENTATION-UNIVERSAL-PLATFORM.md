...
below).
Otherwise the next R3 work is §370/#549 (the `Float`-slot call-site conversion bug) and then
maintainer decisions (3.3/3.5/3.8); the Native scalar ABI (3.7) landed 20/09.
