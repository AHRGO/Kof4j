...
**Source:** `../IMPLEMENTATION-UNIVERSAL-PLATFORM.md` §8.2 (Native: "deploy/edge/systems") ·
...
> **Rule of this document** (same as `../IMPLEMENTATION-UNIVERSAL-PLATFORM.md`): it is a
...
5. **Codegen exists only for 64-bit targets.** `Target.NATIVE` (x86_64),
   ...
   **32-bit** (ARM Cortex-M Thumb-2, riscv32) — a codegen gap, classified **C** by
   `../IMPLEMENTATION-UNIVERSAL-PLATFORM.md` §8.2(e) ("RISC/ARM codegen").
...
target" (`../IMPLEMENTATION-UNIVERSAL-PLATFORM.md` §16) is **not** violated if this is a
