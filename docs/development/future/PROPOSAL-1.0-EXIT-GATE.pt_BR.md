...
**Status:** PROPOSTA — NÃO RATIFICADA  
**Issue de acompanhamento:** [#560](https://github.com/KofLang/Kof4j/issues/560) (DESIGN REQUEST à mantenedora)  
**Local:** `docs/development/future/` — plano **sem código** e **não normativo**; não está em `DECISIONS.md`.  
...
> ## REVISÃO E APROVAÇÃO DA MEL SÃO OBRIGATÓRIAS
>
> Este documento NÃO é uma decisão já tomada pelo projeto.
>
> Ele reúne o contrato atual do KOF, o estado real do repositório e as
> orientações da mantenedora que estão publicadas no Git ou que foram
> registradas no Git como ordens dadas fora dele.
>
> **Nenhum agente ou contribuidor pode ratificar este documento em nome da Mel.**
>
> Somente após revisão e aprovação explícita da Mel este contrato poderá:
>
> 1. virar decisão normativa em `docs/development/DECISIONS.md`;
> 2. ser sincronizado com os documentos de release/versionamento;
> 3. ser transformado em gates automáticos obrigatórios;
> 4. orientar o corte do primeiro Release Candidate de 1.0.
...
Nenhum agente preenche este bloco em nome da mantenedora.
...
**Este documento continua sendo PROPOSTA — NÃO RATIFICADA.** Nenhum bloco de aprovação foi preenchido.
