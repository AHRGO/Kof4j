...
**Fonte:** `../PLAN-UNIVERSAL-PLATFORM.md` §8.2 (Native: "deploy/edge/sistemas") ·
...
> **Regra deste documento** (mesma do `../PLAN-UNIVERSAL-PLATFORM.md`): é um registo
...
5. **O codegen existe só para 64 bits.** `Target.NATIVE` (x86_64),
   ...
   **C** por `../PLAN-UNIVERSAL-PLATFORM.md` §8.2(e) ("RISC/ARM codegen").
...
domínio" (`../PLAN-UNIVERSAL-PLATFORM.md` §16) **não** é violada se isto for um
