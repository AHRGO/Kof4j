...
| `workflow-plan.md` | **MOVIDO 19/09 para `../workflow-plan.md`** — o poll da mantenedora (Q1–Q4) abriu a front com owner `.18`: plano com implementação pendente vive em `docs/development/` (regra dos 3 estados). |
