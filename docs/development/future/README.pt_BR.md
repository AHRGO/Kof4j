...
| `PROPOSAL-1.0-EXIT-GATE.md` | **KOF 1.0 EXIT GATE** — contrato de saída objetivo proposto Beta → RC → Stable (16 itens de evidência obrigatórios; o RC congela a superfície pública, não a Beta) — issue de acompanhamento #560 | **PROPOSTA — NÃO RATIFICADA, zero código** — aguarda a revisão da Mel; **não** está no `DECISIONS.md`, nada é imposto; nenhum agente pode ratificar nem preencher o bloco de aprovação |
