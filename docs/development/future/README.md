...
| `workflow-plan.md` | **MOVED 19/09 to `../workflow-plan.md`** — the maintainer poll (Q1–Q4) opened the front with owner `.18`: a plan with pending implementation lives in `docs/development/` (three-states rule). |
