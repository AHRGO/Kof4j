...
| `PROPOSAL-1.0-EXIT-GATE.md` | **KOF 1.0 EXIT GATE** — proposed objective exit contract Beta → RC → Stable (16 mandatory evidence items; RC freezes the public surface, not the Beta) — tracking issue #560 | **PROPOSAL — NOT RATIFIED, zero code** — awaits Mel's review; **not** in `DECISIONS.md`, nothing is enforced; no agent may ratify or fill its approval block |
