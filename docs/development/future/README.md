...
| ~~`secrets-plan.md`~~ **promoted 21/09 → [`../secrets-plan.md`](../secrets-plan.md)** | `Secret`/`KeyHandle` + enforced redaction (Stage 5, tracker 3.6) | no longer in `future/` — **face 1 authorized** (three-states: implementation pending) |
