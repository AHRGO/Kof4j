...
| R3 | Formalizar FFI como first-class | 🟡 | primeira fatia aberta pela #431 (raylib): incrementos (1) aridade, (2) retornos `void`, (3) retorno String, (4) `const char*` misturado com numéricos — todos aditivos no JVM (padrão `FfiE2ETest`); structs ficam R3-proper (decisão de design ⛔); lado native espera §61 |
