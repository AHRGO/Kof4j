...
| 2.6 | Tooling: `kof workflow run` | ⏳ | — | pré-requisito 2.1.3 ✅ 19/09. O CONTRATO do comando e decisao da mantenedora (rule 6): exit-code/flags/saida-humana do runner dedicado — nada bloqueia CI enquanto isso: `kof run pipeline.kf` ja e o runner (verde=0/vermelho!=0, medido na linha 2.5 + `automation.md`). Rascunhar opcoes A/B/C em planning quando ela abrir o front. |
