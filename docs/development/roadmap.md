...
| 13.2 | §271 — bridge methods on generic-interface impls (erasure ABI) | compiler (**9092, CLAIMED 23/09**) | JVM face ✅ (§356 `c8d55a10`); Native face = §483 (**open**) — `NoSuchMethodError` closed, suite green |
