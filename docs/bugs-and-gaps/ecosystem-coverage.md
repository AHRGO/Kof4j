...
> **0.4.0-beta** and the suite has **2214 tests** across the 4 modules (1907 kof-compiler
> + 38 kof-script + 7 kof-c-compiler + 262 kof-cli; baseline measured 09/16 ~11:38, see
