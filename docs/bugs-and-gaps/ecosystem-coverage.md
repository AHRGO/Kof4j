...
> **0.4.0-beta** and the suite has **2215 tests** across the 4 modules (1908 kof-compiler
> + 38 kof-script + 7 kof-c-compiler + 262 kof-cli; baseline measured 09/16 ~15:09, see
