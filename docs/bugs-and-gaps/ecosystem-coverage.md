...
| custom status codes | ✅ `status(201, body)` (08/27) | y | – WEB001 | – WEB001 | KofWebE2ETest | stdlib/stdlib-web.md |
| custom response headers | ✅ `headerSet("X","y")` (08/27) | y | – WEB001 | – WEB001 | KofWebE2ETest | stdlib/stdlib-web.md |
...
| SSE | ✅ `sse.send/event/close` (JVM, 08/30) | y | – WEB003 | – WEB003 (compile-time gate 16/09; was silent no-op) | KofWebSseE2ETest (7) | stdlib/stdlib-web.md |
