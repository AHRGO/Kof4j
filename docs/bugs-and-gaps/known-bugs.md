...
- **Honestidade do registro:** não re-executo isolado para cravar a
  determinística neste host — o dependabot no HEAD bumpou
  mariadb→3.5.3/postgresql→42.7.7/junit→6.1.3 e o `.m2` local tem só
