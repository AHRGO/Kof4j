...
### §176 — Lambda com corpo em BLOCO que retorna uma LOCAL declarada no próprio bloco é tipada VOID quando o módulo contém uma classe (SEM033) — 🟡 ABERTO (achado 13/09 na caça Q4 do translator, dono = lane compiler)
