...
registro ("diagnóstico em compile-time") foi implementada: **SEM063** no frontend
único (`ExpressionInstanceCallLowerer`, o ramo de String, ao lado do SEM052)
...
rejeitadas com SEM063, incl. o repro exato do §193; `rows.get(0)` + métodos de
