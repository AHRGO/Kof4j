...
registro ("diagnóstico em compile-time") foi implementada: **SEM064** no frontend
único (guarda `StringReceiverGuards.check`, chamada do ramo de String do
`ExpressionInstanceCallLowerer` ao lado do SEM052; SEM063 já estava tomado pelo
guard de visibilidade de campo do #331/#327, então §176 — quem chega depois
renumera — dá a este o SEM064)
...
rejeitadas com SEM064, incl. o repro exato do §193; `rows.get(0)` + métodos de
...
(SEM052/SEM064/SEM051, que só emitem diagnostics e nunca tocam a pilha da IR)
