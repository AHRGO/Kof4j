...
- **Estado:** 🔴 ABERTO 16/09 — catalogado pela lane docs/development
  ...
  `.18` (DB001, autora de `3e55df51`) pelo #773; lane compiler `.22` (autora de
  `78b733fa`) pelo #775; §259 (guard do http nativo, `.15`/`.17`) pelo #776; lane SSE
  da mantenedora (autora de `7cd69a7b`) pelo #777 (#774 já fechado pela `.17` em
