...
- **Nota de numeracao:** reivindicado como §354 em voo; o tip remoto publicou o proprio §354 (temporario `Object` de campo herdado, `128f409c`) durante esta edicao — pela regra de claim compartilhado §NNN este lado foi renumerado §355 (o assunto do commit foi reescrito para casar); ambos os lados preservados.
