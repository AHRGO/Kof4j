...
## §343 — suite vermelha no tip (nao e o fix do §342, mesma autora): `09e40afb` quebrou o codegen JS de switch-case — `BackendParityTest.parityArrayAndSwitch` ICE `COMP002: unexpected op in switch case: KofConditionalJump[comparison=NE...]` — 🔴 ABERTA, rota: lane JS (`.15`/KofJS)
