...
- **Estado:** 🔴 ABERTO — catalogado 15/09 pela lane bugs-and-gaps
  `192.168.100.15`; **não corrigido aqui** (regra 6: mudança de contrato +
  frente de outra lane). Bloqueia o portão de release: 39 vermelhos no tip
  da origin.
