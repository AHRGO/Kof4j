...
## §303 — `CmdBuild.java` cruzou a linha CRÍTICA de 600 no origin (check_500 vermelho para TODO push) — 🟡 ABERTO (dívida da lane X9/§299 deploy; catalogado pela lane `.22` 18/09)
