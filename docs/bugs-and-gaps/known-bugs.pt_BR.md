...
### §284 — backends native: erasure-box (`kof_box`/`kof_unbox`) é NO-OP SILENCIOSO → primitivo-para-Object (`var o: Object = 99`, `h.o = 99`) SIGSEGVa no native (x86 + riscv64 + aarch64) — stub PRE-EXISTENTE catalogado durante a face B do §253 (18/09, lane `.17`) — 🟡 ABERTO (lane nat; stub Q7)
