...
### §238 — join do if-else do decompiler (Fase C degrau 2a): local declarado DENTRO de um ramo emite `var` dentro do `if` e o le apos o join → saida recuperada NAO COMPILA (SEM000 `Undefined variable`)
