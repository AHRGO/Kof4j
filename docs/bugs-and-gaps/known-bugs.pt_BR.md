...
### §263 — KofJS imprimia Double/Float com o `Number.toString` cru (`4`, `10000000`), não o contrato do JDK (`4.0`, `1.0E7`) — divergência silenciosa da regra 5 em println/print/concat/`String.valueOf`/`.toString()` — ✅ CORRIGIDO 16/09 (lane development, dono = 192.168.100.18)
