...
| double println shortest-repr + científico | `0.30000000000000004` / `1.0E7` / `1.0E-5` / `33.333333333333336` / `0.33333334` / `1.0E20` | DONE | PARTIAL (bug §180 — `%.16g` trunca p/ `0.3`/`10000000.0`/`1e-05`; Float vira expansão double `0.3333333432674408`) | DONE | PARTIAL (doc: `Number.toString` não emite `.0`/científico no limiar JDK) | `doubleprint` |
