...
| class method overload by signature (§131, decision 10a) | `42` / `7` | DONE | DONE | DONE | DONE | `methodoverload` (instance only; STATIC-overload face NOT covered — call omitted from IR, `§227`/issue #235 open) |
