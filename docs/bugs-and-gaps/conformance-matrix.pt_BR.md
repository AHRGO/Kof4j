...
| escrita de campo nullable-primitivo + leitura (`b.n = 42`) — §361 | `42` | CONCLUIDO (`e293c4a5`) | CONCLUIDO nao-Char; ⚠️ `Char?` morre na leitura pos-escrita | CONCLUIDO | CONCLUIDO nao-Char; ⚠️ `Char?` morre no class-load | `NullablePrimitiveFieldWriterE2ETest` 9/9 — face char deve entrar RED (adendo §361) |
| LEITURA de campo nullable nunca-escrito — §365 | `null` | CONCLUIDO | CONCLUIDO | **FALHA — `0`** | CONCLUIDO | §365 (ctor JS inicializa o slot com o default cru) |
