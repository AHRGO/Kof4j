...
class TargetMatrixTest {
    ...
    void wasmGapMessagePointsToRealPlanPath() {
        ...
        // docs/development/decision-pending/PLATFORM-PLAN.md docs/development/ é caminho
        ...
        assertTrue(msg.contains("docs/development/decision-pending/PLATFORM-PLAN.md"),
        ...
        for (int i = 0; i < 6 && p != null; i++, p = p.getParent()) {
            java.nio.file.Path cand = p.resolve("docs/development/decision-pending/PLATFORM-PLAN.md");
