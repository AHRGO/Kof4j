...
class TargetMatrixTest {
    ...
    void wasmGapMessagePointsToRealPlanPath() {
        ...
        // docs/development/PLATFORM-PLAN.md (docs/future/ é caminho
        ...
        assertTrue(msg.contains("docs/development/PLATFORM-PLAN.md"),
        ...
        for (int i = 0; i < 6 && p != null; i++, p = p.getParent()) {
            java.nio.file.Path cand = p.resolve("docs/development/PLATFORM-PLAN.md");
