...
public final class StdCatalog {
    ...
    private static final Map<String, Map<String, List<String>>> SIGNATURES =
            ...
            Map.entry("crypto", java.util.Map.ofEntries(
                    ...
                    Map.entry("encryptAesGcm", List.of("encryptAesGcm(String key, String data) -> String")),
                    Map.entry("decryptAesGcm", List.of("decryptAesGcm(String key, String data) -> String")),
                    Map.entry("encryptChacha20", List.of("encryptChacha20(String key, String data) -> String")),
                    Map.entry("decryptChacha20", List.of("decryptChacha20(String key, String data) -> String")),
            ...
            Map.entry("security", java.util.Map.ofEntries(
                    ...
                    Map.entry("sessionCreate", List.of("sessionCreate(String user) -> String")),
                    ...
                    Map.entry("cookieGet", List.of("cookieGet(String name, String value) -> String")))),
