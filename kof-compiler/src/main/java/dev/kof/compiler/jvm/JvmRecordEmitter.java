...
public final class JvmRecordEmitter {
    ...
    private static void emitEqualsComparison(MethodVisitor mv, Type type, String cn) {
        ...
        // já dá false para NullableType (tipos distintos), então cai
        // naturalmente no ramo de referência abaixo (`Objects.equals`,
        // null-safe e correto para I6 — nenhum unwrap manual necessário).
    ...
    private static void emitHashContribution(MethodVisitor mv, Type type) {
        // D-NULL-INTENT (#278, supersede #127): mesma razão do equals acima
        // — Nullable(primitivo) é referência de verdade, cai no `Objects.
        // hashCode` (null-safe) do ramo else abaixo.
