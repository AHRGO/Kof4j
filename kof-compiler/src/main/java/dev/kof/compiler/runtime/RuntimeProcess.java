 ...
 * 104 (revents em 102 e 110), buffer de leitura 112..4207. Total 4224
    ...
    public static void emit(StringBuilder sb) {
        sb.append("""
            ...
            kof_process_run:
                ...
                movq $0, 32(%r14)
                movq $0, 40(%r14)
                # bissec: buffers PRE-ALOCADOS (sem grow no dreno) — outbuf/errbuf
                # 1 MiB cada + chunk 4 KiB no heap; liberados em todo epilogo.
                movl $1048576, %edi
                call kof_alloc
                movq %rax, 48(%r14)
                movq $0, 56(%r14)
            ...
            .Lkof_proc_run_wait:
                ...
                movl $61, %eax
                syscall
                # 1) copia AMBOS os stream-strings ANTES de liberar: o destino
                # do from_literal tem que ser mmap fresco — se o buffer de
                # origem ja estiver na free list, o alocador REUSA o proprio
                # bloco de origem e a copia se sobrescreve (medido: stderr
                # vazia/corrompida). 2) frees so depois. 3) o alloc do Result
                # fica POR ULTIMO (rax = valor de retorno; kof_free clobbera
                # rax).
                movq 48(%r14), %rdi
                movq 56(%r14), %rsi
