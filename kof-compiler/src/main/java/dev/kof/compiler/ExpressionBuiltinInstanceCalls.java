...
final class ExpressionBuiltinInstanceCalls {
    ...
    private static final Set<String> CROSS_IO_READY = Set.of(
            ...
            "kof_io_path_resolve", "kof_io_path_normalize", "kof_io_path_to_absolute", "kof_io_dir_delete", "kof_io_file_modified_time", "kof_io_file_is_symlink", "kof_io_file_move_to");
