...
> **PRÓXIMO PASSO (re-dispacho lê isto, lane bugs-and-gaps):** portão re-medido no tip `c48006b1` = **1 fail, SÓ o §205** (lane #183, alheio) — ESTÁVEL. Varredura de issues fechada: **#261 ✅ fechada** (`9efba38d`), **#267 ✅ fechada** (`7137d978`); **#266/#259** abertas = face boxed do `Nullable(primitivo)`, regra 6 (reabre §125) — reconciliação postada; #168/#153 (Char, lane .17), #160 (lane .22), #159/#151 (decisão), #148 (lane .17) = regra 6/lane alheia. **Nada reprodutível e corrigível nesta lane** → **recusar re-trigger** (estabilidade) até surgir vermelho novo ou item de fila próprio.
