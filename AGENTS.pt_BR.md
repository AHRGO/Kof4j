...
1. **Zero regressão.** Nenhum commit pode fazer um teste existente passar a
   falhar. A suíte completa (`mvn test`, hoje **2546** nos 4 módulos — ver
...
> é **2546 testes** (compiler 2192 + script 39 + kof-c 7 + cli 308, medição
> 18/09 ~14:10 no CI run do tip `96ab646e` — cresce com cada commit): **0 regressões / 0 erros**
...
> CI Build+Tests + riscv64/aarch64 sob qemu): **2546 = 2192+39+7+308, 0F / 0E / 11 skip** — o flake
