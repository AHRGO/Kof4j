...
1. **Zero regression.** No commit may make an existing test start to
   fail. The full suite (`mvn test`, today **2575** across the 4 modules — see
...
> is **2575 tests** (compiler 2216 + script 39 + kof-c 7 + cli 313, measurement
...
> `d14275f0`): **2575 = 2216+39+7+313, 0F / 0E / 177 skip** (no-qemu guards; cli 308→313 by `CmdBuildClasspathTest` of #441 in `d14275f0`; CI Build+Tests of `d14275f0` measured; cross e2e green
