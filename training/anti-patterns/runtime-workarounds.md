[English](runtime-workarounds.md) | [Português](runtime-workarounds.pt_BR.md)
...
### 3. Constructor with arguments — RESOLVED (0.5.0-beta)
...
### 4. Capture in lambdas — RESOLVED (0.5.0-beta)
