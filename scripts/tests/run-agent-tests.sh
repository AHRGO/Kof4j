...
for extra in agent-state-fingerprint agent-dispatch-gate agent-risk agent-evidence agent-verify agent-close-issue check-release-blockers test-package-outside-repo codeql-gate; do
