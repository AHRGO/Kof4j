...
>
> **⚡ EM CURSO (16/09 ~03:40, dono = 192.168.100.18, lane development): DB001 no JS — ponte `kof_platform.db*` no host GraalJS (regra absoluta da mantenedora: roadmap "Em desenvolvimento" = prioridade, frente UI/web/db desta lane).** **Blueprint fechado por leitura do código (não reimplementar; lição §241: unidade inteira, nunca half-landing):**
